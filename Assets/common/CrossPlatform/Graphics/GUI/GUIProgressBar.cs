...
namespace HEXPLAY
{
	public class GUIProgressBar : GUIElement
	{
		...
		public GUIProgressBar(GUIText text, Game.GUIStyle style = Game.GUIStyle.Default, GUIAnimation animation = default(GUIAnimation), int percentWidth = 0, int width = -1, int height = -1, int minWidth = int.MinValue, int minHeight = int.MinValue, int maxWidth = int.MaxValue, int maxHeight = int.MaxValue) : base(minWidth, minHeight, maxWidth, maxHeight)
		{
			if(animation != null)
		...
		public void SetProgress(Fixed progress, string progressText)
		{
